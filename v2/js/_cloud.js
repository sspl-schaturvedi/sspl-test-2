	...
	var pluginName = "awesomeCloud", // name of the plugin, mainly for canvas IDs
		defaultSettings = {
			...
			"options": {
				...
				"sort": "higest" // "highest" to show big words first, "lowest" to do small words first, "random" to not care
			},
			"font": "Bevan", // the CSS font-family string
			"shape": "Rectangle" // the selected shape keyword, or a theta function describing a shape
		};
